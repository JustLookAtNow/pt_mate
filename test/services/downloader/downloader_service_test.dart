...
void main() {
  group('DownloaderService Tests', () {
    ...
    test(
      'getUpdatedConfigAndSave should return existing config if version is present',
      () async {
    ...
    test(
      'getUpdatedConfigAndSave should fetch version and save if version is missing',
      () async {
        final config = QbittorrentConfig(
          id: 'test_id',
          name: 'Test QB',
    ...
    test(
      'getUpdatedConfigAndSave should return original config and not save on error',
      () async {
        final config = QbittorrentConfig(
          id: 'test_id',
          name: 'Test QB',
    ...
    test(
      'getUpdatedConfigAndSave should not save if autoSave is false',
      () async {
        final config = QbittorrentConfig(
          id: 'test_id',
          name: 'Test QB',
