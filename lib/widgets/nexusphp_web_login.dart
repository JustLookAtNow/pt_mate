...
class _NexusPhpWebLoginState extends State<NexusPhpWebLogin> {
  ...
  Future<void> _extractCookie() async {
    try {
      ...
      final cookies = await cookieManager.getCookies(url: WebUri(widget.baseUrl));
      ...
      if (cookies.isNotEmpty) {
        ...
        // 将cookie转换为标准格式
        final cookieStrings = updatedCookies.map((cookie) => '${cookie.name}=${cookie.value}').toList();
        ...
        children: [
          ...
          Expanded(
            child: _errorMessage != null
                ...
                : InAppWebView(
                    initialUrlRequest: URLRequest(url: WebUri('${widget.baseUrl}/login.php')),
